...
##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##-##
#
#  Model-1: the coarse-grained model generated by applying the following constant mapping:
#
...
readFrom(internal_office, customer_relationship_management, customers)
readFrom(internal_office, customer_relationship_management, sales_contracts)
writeTo(internal_office, customer_relationship_management, customers)
writeTo(internal_office, customer_relationship_management, sales_contracts)
readFrom(internal_office, asset_management, assets)
readFrom(internal_office, human_resource_management, human_resources)
readFrom(internal_office, communication, documents)
readFrom(internal_office, communication, messages)
writeTo(internal_office, asset_management, assets)
writeTo(internal_office, human_resource_management, human_resources)
writeTo(internal_office, communication, documents)
writeTo(internal_office, communication, messages)

readFrom(internal_office, enterprise_resource_planning, sales_contracts)
readFrom(internal_office, enterprise_resource_planning, materials)
readFrom(internal_office, enterprise_resource_planning, purchase_contracts)
readFrom(internal_office, enterprise_resource_planning, assets)
writeTo(internal_office, enterprise_resource_planning, sales_contracts)
writeTo(internal_office, enterprise_resource_planning, materials)
writeTo(internal_office, enterprise_resource_planning, purchase_contracts)
writeTo(internal_office, enterprise_resource_planning, assets)

readFrom(internal_office, accounting, sales_contracts)
readFrom(internal_office, accounting, materials)
readFrom(internal_office, accounting, purchase_contracts)
readFrom(internal_office, accounting, assets)
readFrom(internal_office, accounting, human_resources)
writeTo(internal_office, accounting, sales_contracts)
writeTo(internal_office, accounting, materials)
writeTo(internal_office, accounting, purchase_contracts)
writeTo(internal_office, accounting, assets)
